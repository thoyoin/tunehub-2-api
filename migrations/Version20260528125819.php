 ...
 */
final class Version20260528125819 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE track ADD CONSTRAINT `FK_D6E3F8A66BBD148` FOREIGN KEY (playlist_id) REFERENCES playlist (id) ON UPDATE NO ACTION ON DELETE SET NULL');
